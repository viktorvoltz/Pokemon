...
//
//     final PokenModel = PokenModelFromJson(jsonString);

import 'dart:convert';

PokenModel pokenModelFromJson(String str) => PokenModel.fromJson(json.decode(str));

String pokenModelToJson(PokenModel data) => json.encode(data.toJson());
...
class PokenModel {
  List<Ability>? abilities;
    ...
    factory PokenModel.fromJson(Map<String, dynamic> json) => PokenModel(
...
class Versions {
    ...
    factory Versions.fromJson(Map<String, dynamic> json) => Versions(
        ...
        generationVi: json["generation-vi"] == null ? null : Map.from(json["generation-vi"]).map((k, v) => MapEntry<String, Home>(k, Home.fromJson(v))),
...
class RedBlue {
    ...
    factory RedBlue.fromJson(Map<String, dynamic> json) => RedBlue(
        ...
        backTransparent: json["back_transparent"] == null ? null : json["back_transparent"],
        frontDefault: json["front_default"] == null ? null : json["front_default"],
...
class Crystal {
    ...
    factory Crystal.fromJson(Map<String, dynamic> json) => Crystal(
        backDefault: json["back_default"] == null ? null : json["back_default"],
        backShiny: json["back_shiny"] == null ? null : json["back_shiny"],
        backShinyTransparent: json["back_shiny_transparent"] == null ? null : json["back_shiny_transparent"],
        backTransparent: json["back_transparent"] == null ? null : json["back_transparent"],
        frontDefault: json["front_default"] == null ? null : json["front_default"],
        frontShiny: json["front_shiny"] == null ? null : json["front_shiny"],
        frontShinyTransparent: json["front_shiny_transparent"] == null ? null : json["front_shiny_transparent"],
        frontTransparent: json["front_transparent"] == null ? null : json["front_transparent"],
    );
    ...
    Map<String, dynamic> toJson() => {
        "back_default": backDefault == null ? null : backDefault,
        "back_shiny": backShiny == null ? null : backShiny,
        "back_shiny_transparent": backShinyTransparent == null ? null : backShinyTransparent,
        "back_transparent": backTransparent == null ? null : backTransparent,
        "front_default": frontDefault == null ? null : frontDefault,
        "front_shiny": frontShiny == null ? null : frontShiny,
        "front_shiny_transparent": frontShinyTransparent == null ? null : frontShinyTransparent,
        "front_transparent": frontTransparent == null ? null : frontTransparent,
    };
}
